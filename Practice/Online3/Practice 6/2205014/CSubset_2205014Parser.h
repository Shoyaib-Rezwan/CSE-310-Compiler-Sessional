...
public:
  ...
  class  Dec_lstID2Context : public Declaration_listContext {
  public:
    Dec_lstID2Context(Declaration_listContext *ctx);
  ...
  class  Dec_lstCommaID2Context : public Declaration_listContext {
  public:
    Dec_lstCommaID2Context(Declaration_listContext *ctx);
