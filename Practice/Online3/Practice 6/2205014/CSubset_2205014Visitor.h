...
public:
   ...
   */
    ...
    virtual std::any visitDec_lstID2(CSubset_2205014Parser::Dec_lstID2Context *context) = 0;

    virtual std::any visitDec_lstCommaID(CSubset_2205014Parser::Dec_lstCommaIDContext *context) = 0;

    virtual std::any visitDec_lstCommaID2(CSubset_2205014Parser::Dec_lstCommaID2Context *context) = 0;
