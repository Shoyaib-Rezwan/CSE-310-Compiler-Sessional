...
public:
  ...
  virtual std::any visitDec_lstID2(CSubset_2205014Parser::Dec_lstID2Context *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitDec_lstCommaID2(CSubset_2205014Parser::Dec_lstCommaID2Context *ctx) override {
    return visitChildren(ctx);
  }
