...
public:
   ...
   */
    ...
    virtual std::any visitEXprAdd(CSubset_2205014Parser::EXprAddContext *context) = 0;

    virtual std::any visitEXprMul(CSubset_2205014Parser::EXprMulContext *context) = 0;
