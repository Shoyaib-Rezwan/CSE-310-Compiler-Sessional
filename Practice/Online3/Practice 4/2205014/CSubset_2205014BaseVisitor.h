...
public:
  ...
  virtual std::any visitEXprAdd(CSubset_2205014Parser::EXprAddContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitEXprMul(CSubset_2205014Parser::EXprMulContext *ctx) override {
    return visitChildren(ctx);
  }
