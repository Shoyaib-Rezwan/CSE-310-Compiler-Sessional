...
public:
  enum {
    ...
    DECOP = 25, NOT = 26, RELOP = 27, LOGICOP = 28, ASSIGNOP = 29, QUESTION = 30, 
    COLON = 31, ID = 32, CONST_INT = 33, CONST_FLOAT = 34
  };
  ...
  class  StmtTerContext : public StatementContext {
  public:
    StmtTerContext(StatementContext *ctx);
  ...
  class  DecopFactorContext : public FactorContext {
  public:
    DecopFactorContext(FactorContext *ctx);
  ...
  class  IncopFactorContext : public FactorContext {
  public:
    IncopFactorContext(FactorContext *ctx);
