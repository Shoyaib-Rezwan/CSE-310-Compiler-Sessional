...
public:
   ...
   */
    ...
    virtual std::any visitStmtTer(CSubset_2205014Parser::StmtTerContext *context) = 0;
    ...
    virtual std::any visitIncopFactor(CSubset_2205014Parser::IncopFactorContext *context) = 0;

    virtual std::any visitDecopFactor(CSubset_2205014Parser::DecopFactorContext *context) = 0;
