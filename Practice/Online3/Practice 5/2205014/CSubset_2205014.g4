...
statement
    ...
    | variable ASSIGNOP LPAREN logic_expression RPAREN QUESTION logic_expression COLON logic_expression SEMICOLON #stmtTer
    ;
...
factor
    ...
    | INCOP variable                    # IncopFactor
    | DECOP  variable                   # DecopFactor
    ;
